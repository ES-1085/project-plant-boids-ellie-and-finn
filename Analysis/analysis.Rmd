...
-
```{r, ggplot-map-of-nests-on-gdi, fig.width=20}
island_bird %>%
filter(location == "gdi") %>%
ggplot() +
...
```
-
```{r, ggplot-map-of-nests-on-heron, fig.width=20}
island_bird %>%
...
```
-
```{r, ggplot-map-of-nests-on-schoodic, fig.width=20}
island_bird %>%
...
```
-
```{r, ggplot-map-of-nests-on-shabby, fig.width=20}
island_bird %>%
