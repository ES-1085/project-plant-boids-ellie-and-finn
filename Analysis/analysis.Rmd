...
```{r assign-colors-to-bird-species}
 colors <- c("herring gull" = "#2B899E", 
             "great black-backed gull" = "#3F2E71", 
             "common eider" = "#81A356", 
             "canada goose" = "#5ec962", 
...
```{r assign-colors-to-bird-species-for-leaflet}
 bird_color <- colorFactor(palette = c("#2B899E", "#3F2E71", "#81A356", "#5ec962", "#3b528b"),
...
```{r 2-leaflet-map-of-height-and-bird-species}
leaflet() %>% 
  #basemap
  addProviderTiles("CartoDB.Positron") %>% 
  #setView to show all islands
